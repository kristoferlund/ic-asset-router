...
thread_local! {
    ...
    /// Tracks which paths were dynamically generated by handlers (as opposed to
    /// static assets embedded at compile time). Used by the invalidation API to
    /// selectively clear dynamic assets without affecting static ones.
    static DYNAMIC_PATHS: RefCell<HashSet<String>> = RefCell::new(HashSet::new());
}
